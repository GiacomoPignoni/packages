  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?) {
    ...
    if (value is android.util.Size) {
      ...
      registrar.getPigeonApiVideoRecordEventStart().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("VideoRecordEventStart", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiResolutionStrategy().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("ResolutionStrategy", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiResolutionSelector().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("ResolutionSelector", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiCameraStateStateError().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("CameraStateStateError", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiFocusMeteringActionBuilder().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("FocusMeteringActionBuilder", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiFocusMeteringAction().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("FocusMeteringAction", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiFocusMeteringResult().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("FocusMeteringResult", value, it.exceptionOrNull())
        }
      }
    } else if (value is android.hardware.camera2.CaptureRequest) {
      registrar.getPigeonApiCaptureRequest().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("CaptureRequest", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiCaptureRequestKey().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("CaptureRequestKey", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiCaptureRequestOptions().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("CaptureRequestOptions", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiCamera2CameraControl().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("Camera2CameraControl", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiResolutionFilter().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("ResolutionFilter", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiCameraCharacteristicsKey().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("CameraCharacteristicsKey", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiCameraCharacteristics().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("CameraCharacteristics", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiCamera2CameraInfo().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("Camera2CameraInfo", value, it.exceptionOrNull())
        }
      }
      ...
      registrar.getPigeonApiDisplayOrientedMeteringPointFactory().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("DisplayOrientedMeteringPointFactory", value, it.exceptionOrNull())
        }
      }
