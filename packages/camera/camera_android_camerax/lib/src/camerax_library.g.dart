...
class PigeonOverrides {
  ...
  cameraIntegerRange_new;

  /// Overrides [Observer.new].
  static Observer Function({
    required void Function(Observer pigeon_instance, Object value) onChanged,
  })?
  observer_new;
  ...
  /// Overrides [ImageCapture.new].
  static ImageCapture Function({
    ResolutionSelector? resolutionSelector,
    int? targetRotation,
  ...
  static ResolutionStrategy Function({
    required CameraSize boundSize,
    required ResolutionStrategyFallbackRule fallbackRule,
  })?
  resolutionStrategy_new;

  /// Overrides [ResolutionSelector.new].
  ...
  /// Overrides [AspectRatioStrategy.new].
  static AspectRatioStrategy Function({
    required AspectRatio preferredAspectRatio,
    required AspectRatioStrategyFallbackRule fallbackRule,
  })?
  aspectRatioStrategy_new;

  /// Overrides [ImageAnalysis.new].
  ...
  /// Overrides [Analyzer.new].
  static Analyzer Function({
    required void Function(Analyzer pigeon_instance, ImageProxy image) analyze,
  })?
  analyzer_new;

  /// Overrides [QualitySelector.from].
  static QualitySelector Function({
    required VideoQuality quality,
    FallbackStrategy? fallbackStrategy,
  })?
  qualitySelector_from;

  /// Overrides [QualitySelector.fromOrderedList].
  static QualitySelector Function({
    required List<VideoQuality> qualities,
    FallbackStrategy? fallbackStrategy,
  })?
  qualitySelector_fromOrderedList;

  /// Overrides [FallbackStrategy.higherQualityOrLowerThan].
  static FallbackStrategy Function({required VideoQuality quality})?
  fallbackStrategy_higherQualityOrLowerThan;

  /// Overrides [FallbackStrategy.higherQualityThan].
  static FallbackStrategy Function({required VideoQuality quality})?
  fallbackStrategy_higherQualityThan;

  /// Overrides [FallbackStrategy.lowerQualityOrHigherThan].
  static FallbackStrategy Function({required VideoQuality quality})?
  fallbackStrategy_lowerQualityOrHigherThan;

  /// Overrides [FallbackStrategy.lowerQualityThan].
  static FallbackStrategy Function({required VideoQuality quality})?
  fallbackStrategy_lowerQualityThan;

  /// Overrides [FocusMeteringActionBuilder.new].
  static FocusMeteringActionBuilder Function({required MeteringPoint point})?
  focusMeteringActionBuilder_new;

  /// Overrides [FocusMeteringActionBuilder.withMode].
  static FocusMeteringActionBuilder Function({
  ...
  static Camera2CameraControl Function({required CameraControl cameraControl})?
  camera2CameraControl_from;

  /// Overrides [ResolutionFilter.createWithOnePreferredSize].
  static ResolutionFilter Function({required CameraSize preferredSize})?
  ...
  displayOrientedMeteringPointFactory_new;

  /// Overrides [PlatformEffectsValues.new].
  static PlatformEffectsValues Function({
  ...
  /// Overrides [ViewPort.new].
  static ViewPort Function({
  ...
  /// Overrides [CameraEffectsManager.new].
  static CameraEffectsManager Function({
    required void Function(CameraEffectsManager pigeon_instance, int width, int height)
    onPreviewSizeChanged,
    required void Function(CameraEffectsManager pigeon_instance) onPreviewOutputLost,
    double? aspectRatio,
  })?
  cameraEffectsManager_new;

  /// Overrides [WhiteBalanceManager.new].
  static WhiteBalanceManager Function({
    required void Function(WhiteBalanceManager pigeon_instance, double temperature, double tint)
    onAutoWhiteBalanceChanged,
  })?
  whiteBalanceManager_new;

  /// Overrides [CameraSelector.defaultBackCamera].
  static CameraSelector? cameraSelector_defaultBackCamera;

  /// Overrides [CameraSelector.defaultFrontCamera].
  static CameraSelector? cameraSelector_defaultFrontCamera;

  /// Overrides [ResolutionStrategy.highestAvailableStrategy].
  ...
  /// Overrides [CaptureRequest.controlAELock].
  static CaptureRequestKey? captureRequest_controlAELock;

  /// Overrides [CaptureRequest.controlVideoStabilizationMode].
  ...
  static void pigeon_reset() {
    cameraSize_new = null;
    cameraIntegerRange_new = null;
    observer_new = null;
    cameraSelector_new = null;
    cameraSelector_defaultBackCamera = null;
    cameraSelector_defaultFrontCamera = null;
    processCameraProvider_getInstance = null;
    systemServicesManager_new = null;
    deviceOrientationManager_new = null;
    preview_new = null;
    videoCapture_withOutput = null;
    recorder_new = null;
    videoRecordEventListener_new = null;
    imageCapture_new = null;
    resolutionStrategy_new = null;
    resolutionStrategy_highestAvailableStrategy = null;
    resolutionSelector_new = null;
    aspectRatioStrategy_new = null;
    aspectRatioStrategy_ratio_16_9FallbackAutoStrategy = null;
    aspectRatioStrategy_ratio_4_3FallbackAutoStrategy = null;
    imageAnalysis_new = null;
    analyzer_new = null;
    imageProxyUtils_getNv21Buffer = null;
    qualitySelector_from = null;
    qualitySelector_fromOrderedList = null;
    qualitySelector_getResolution = null;
    fallbackStrategy_higherQualityOrLowerThan = null;
    fallbackStrategy_higherQualityThan = null;
    fallbackStrategy_lowerQualityOrHigherThan = null;
    fallbackStrategy_lowerQualityThan = null;
    focusMeteringActionBuilder_new = null;
    focusMeteringActionBuilder_withMode = null;
    captureRequest_controlAELock = null;
    captureRequest_controlVideoStabilizationMode = null;
    captureRequestOptions_new = null;
    camera2CameraControl_from = null;
    ...
    cameraCharacteristics_controlAvailableVideoStabilizationModes = null;
    camera2CameraInfo_from = null;
    displayOrientedMeteringPointFactory_new = null;
    platformEffectsValues_new = null;
    viewPort_new = null;
    cameraEffectsManager_new = null;
    whiteBalanceManager_new = null;
  }
}
...
class PigeonInstanceManager {
  ...
  static PigeonInstanceManager _initInstance() {
    ...
    PlatformEffectsValues.pigeon_setUpMessageHandlers(pigeon_instanceManager: instanceManager);
    CapturedPicturePaths.pigeon_setUpMessageHandlers(pigeon_instanceManager: instanceManager);
    CameraEffect.pigeon_setUpMessageHandlers(pigeon_instanceManager: instanceManager);
    ViewPort.pigeon_setUpMessageHandlers(pigeon_instanceManager: instanceManager);
    CameraEffectsManager.pigeon_setUpMessageHandlers(pigeon_instanceManager: instanceManager);
    WhiteBalanceManager.pigeon_setUpMessageHandlers(pigeon_instanceManager: instanceManager);
...
class CameraSize extends PigeonInternalProxyApiBaseClass {
  factory CameraSize({
    ...
    if (PigeonOverrides.cameraSize_new != null) {
      return PigeonOverrides.cameraSize_new!(width: width, height: height);
    }
    return CameraSize.pigeon_new(
...
class Observer extends PigeonInternalProxyApiBaseClass {
  factory Observer({
    ...
    if (PigeonOverrides.observer_new != null) {
      return PigeonOverrides.observer_new!(onChanged: onChanged);
    }
    return Observer.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      onChanged: onChanged,
    );
...
class CameraSelector extends PigeonInternalProxyApiBaseClass {
  factory CameraSelector({
    ...
    if (PigeonOverrides.cameraSelector_new != null) {
      return PigeonOverrides.cameraSelector_new!(
        requireLensFacing: requireLensFacing,
        cameraInfoForFilter: cameraInfoForFilter,
      );
    }
    return CameraSelector.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      requireLensFacing: requireLensFacing,
      cameraInfoForFilter: cameraInfoForFilter,
  ...
  static CameraSelector get defaultBackCamera =>
      PigeonOverrides.cameraSelector_defaultBackCamera ?? _defaultBackCamera;

  /// A static `CameraSelector` that selects the default front facing camera.
  static CameraSelector get defaultFrontCamera =>
      PigeonOverrides.cameraSelector_defaultFrontCamera ?? _defaultFrontCamera;
...
class ProcessCameraProvider extends PigeonInternalProxyApiBaseClass {
  ...
  Future<List<CameraIntegerRange>> getSupportedFrameRateRanges(
    CameraSelector cameraSelector,
    List<UseCase> useCases,
    List<CameraEffect> effects,
    ViewPort? viewPort,
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as List<Object?>?)!.cast<CameraIntegerRange>();
    }
  }
...
class SystemServicesManager extends PigeonInternalProxyApiBaseClass {
  ...
  @protected
  SystemServicesManager.pigeon_new({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
...
class DeviceOrientationManager extends PigeonInternalProxyApiBaseClass {
  factory DeviceOrientationManager({
    ...
    if (PigeonOverrides.deviceOrientationManager_new != null) {
      return PigeonOverrides.deviceOrientationManager_new!(
        onDeviceOrientationChanged: onDeviceOrientationChanged,
      );
    }
    return DeviceOrientationManager.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      onDeviceOrientationChanged: onDeviceOrientationChanged,
    );
  ...
  @protected
  DeviceOrientationManager.pigeon_new({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
...
class VideoCapture extends UseCase {
  ...
  factory VideoCapture.withOutput({
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    required VideoOutput videoOutput,
    CameraIntegerRange? targetFpsRange,
  ...
  /// Create a `VideoCapture` associated with the given `VideoOutput`.
  @protected
  VideoCapture.pigeon_withOutput({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required VideoOutput videoOutput,
    CameraIntegerRange? targetFpsRange,
...
class Recorder extends PigeonInternalProxyApiBaseClass implements VideoOutput {
  factory Recorder({
    ...
    if (PigeonOverrides.recorder_new != null) {
      return PigeonOverrides.recorder_new!(
        aspectRatio: aspectRatio,
        targetVideoEncodingBitRate: targetVideoEncodingBitRate,
        qualitySelector: qualitySelector,
      );
    }
    return Recorder.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      aspectRatio: aspectRatio,
      targetVideoEncodingBitRate: targetVideoEncodingBitRate,
...
class VideoRecordEventListener extends PigeonInternalProxyApiBaseClass {
  factory VideoRecordEventListener({
    ...
    if (PigeonOverrides.videoRecordEventListener_new != null) {
      return PigeonOverrides.videoRecordEventListener_new!(onEvent: onEvent);
    }
    return VideoRecordEventListener.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      onEvent: onEvent,
    );
  ...
  @protected
  VideoRecordEventListener.pigeon_new({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
...
class ImageCapture extends UseCase {
  ...
  /// event.
  Future<CapturedPicturePaths> takePictureWithEffects(
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as CapturedPicturePaths?)!;
    }
  }
...
class ResolutionStrategy extends PigeonInternalProxyApiBaseClass {
  factory ResolutionStrategy({
    ...
    if (PigeonOverrides.resolutionStrategy_new != null) {
      return PigeonOverrides.resolutionStrategy_new!(
        boundSize: boundSize,
        fallbackRule: fallbackRule,
      );
    }
    return ResolutionStrategy.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      boundSize: boundSize,
      fallbackRule: fallbackRule,
...
class ResolutionSelector extends PigeonInternalProxyApiBaseClass {
  factory ResolutionSelector({
    ...
    return ResolutionSelector.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      resolutionFilter: resolutionFilter,
      resolutionStrategy: resolutionStrategy,
...
class AspectRatioStrategy extends PigeonInternalProxyApiBaseClass {
  ...
  factory AspectRatioStrategy({
    ...
    if (PigeonOverrides.aspectRatioStrategy_new != null) {
      return PigeonOverrides.aspectRatioStrategy_new!(
        preferredAspectRatio: preferredAspectRatio,
        fallbackRule: fallbackRule,
      );
    }
    return AspectRatioStrategy.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      preferredAspectRatio: preferredAspectRatio,
      fallbackRule: fallbackRule,
  ...
  /// preferred aspect ratio and fallback rule.
  @protected
  AspectRatioStrategy.pigeon_new({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required AspectRatio preferredAspectRatio,
    required AspectRatioStrategyFallbackRule fallbackRule,
  ...
  /// in priority.
  static final AspectRatioStrategy _ratio_16_9FallbackAutoStrategy =
  ...
  static final AspectRatioStrategy _ratio_4_3FallbackAutoStrategy =
      pigeonVar_ratio_4_3FallbackAutoStrategy();

  /// The pre-defined aspect ratio strategy that selects sizes with RATIO_16_9
  /// in priority.
  static AspectRatioStrategy get ratio_16_9FallbackAutoStrategy =>
      PigeonOverrides.aspectRatioStrategy_ratio_16_9FallbackAutoStrategy ??
      _ratio_16_9FallbackAutoStrategy;

  /// The pre-defined default aspect ratio strategy that selects sizes with
  /// RATIO_4_3 in priority.
  static AspectRatioStrategy get ratio_4_3FallbackAutoStrategy =>
      PigeonOverrides.aspectRatioStrategy_ratio_4_3FallbackAutoStrategy ??
      _ratio_4_3FallbackAutoStrategy;
...
class ImageAnalysis extends UseCase {
  factory ImageAnalysis({
    ...
    return ImageAnalysis.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      resolutionSelector: resolutionSelector,
      targetRotation: targetRotation,
...
class Analyzer extends PigeonInternalProxyApiBaseClass {
  factory Analyzer({
    ...
    if (PigeonOverrides.analyzer_new != null) {
      return PigeonOverrides.analyzer_new!(analyze: analyze);
    }
    return Analyzer.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      analyze: analyze,
    );
...
class ImageProxyUtils extends PigeonInternalProxyApiBaseClass {
    ...
    final BinaryMessenger? binaryMessenger = pigeon_binaryMessenger;
    {
      ...
      if (pigeon_clearHandlers) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(
            message != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.ImageProxyUtils.pigeon_newInstance was null.',
          );
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_pigeon_instanceIdentifier = (args[0] as int?);
          assert(
  ...
  @override
  ImageProxyUtils pigeon_copy() {
    return ImageProxyUtils.pigeon_detached(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
    );
  }
...
class QualitySelector extends PigeonInternalProxyApiBaseClass {
  ...
  factory QualitySelector.from({
    ...
    if (PigeonOverrides.qualitySelector_from != null) {
      return PigeonOverrides.qualitySelector_from!(
        quality: quality,
        fallbackStrategy: fallbackStrategy,
      );
    }
    return QualitySelector.pigeon_from(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      quality: quality,
      fallbackStrategy: fallbackStrategy,
  ...
  factory QualitySelector.fromOrderedList({
    ...
    if (PigeonOverrides.qualitySelector_fromOrderedList != null) {
      return PigeonOverrides.qualitySelector_fromOrderedList!(
        qualities: qualities,
        fallbackStrategy: fallbackStrategy,
      );
    }
    return QualitySelector.pigeon_fromOrderedList(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      qualities: qualities,
      fallbackStrategy: fallbackStrategy,
  ...
  /// Gets an instance of QualitySelector with ordered desired qualities.
  @protected
  QualitySelector.pigeon_fromOrderedList({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required List<VideoQuality> qualities,
    FallbackStrategy? fallbackStrategy,
...
class FallbackStrategy extends PigeonInternalProxyApiBaseClass {
  ...
  /// to and higher than the input quality.
  @protected
  FallbackStrategy.pigeon_higherQualityOrLowerThan({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required VideoQuality quality,
  }) {
  ...
  /// Returns a fallback strategy that will choose the quality that is closest
  /// to and higher than the input quality.
  factory FallbackStrategy.higherQualityThan({
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    required VideoQuality quality,
  }) {
  ...
  /// to and higher than the input quality.
  @protected
  FallbackStrategy.pigeon_higherQualityThan({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required VideoQuality quality,
  }) {
  ...
  /// to and lower than the input quality.
  @protected
  FallbackStrategy.pigeon_lowerQualityOrHigherThan({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required VideoQuality quality,
  }) {
  ...
  /// Returns a fallback strategy that will choose the quality that is closest
  /// to and lower than the input quality.
  factory FallbackStrategy.lowerQualityThan({
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    required VideoQuality quality,
  }) {
  ...
  /// to and lower than the input quality.
  @protected
  FallbackStrategy.pigeon_lowerQualityThan({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required VideoQuality quality,
  }) {
...
class FocusMeteringActionBuilder extends PigeonInternalProxyApiBaseClass {
  ...
  /// FLAG_AE | FLAG_AWB.
  factory FocusMeteringActionBuilder({
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    required MeteringPoint point,
  }) {
    if (PigeonOverrides.focusMeteringActionBuilder_new != null) {
      return PigeonOverrides.focusMeteringActionBuilder_new!(point: point);
    }
    return FocusMeteringActionBuilder.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      point: point,
    );
  ...
  /// FLAG_AE | FLAG_AWB.
  @protected
  FocusMeteringActionBuilder.pigeon_new({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required MeteringPoint point,
  }) {
  ...
  factory FocusMeteringActionBuilder.withMode({
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    required MeteringPoint point,
    required MeteringMode mode,
  ...
  /// Creates a Builder from a `MeteringPoint` and `MeteringMode`.
  @protected
  FocusMeteringActionBuilder.pigeon_withMode({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required MeteringPoint point,
    required MeteringMode mode,
...
class CaptureRequest extends PigeonInternalProxyApiBaseClass {
  ...
  static final CaptureRequestKey _controlAELock = pigeonVar_controlAELock();
  ...
  ///
  /// This key is available on all devices.
  static final CaptureRequestKey _controlVideoStabilizationMode =
  ...
  ///
  /// This key is available on all devices.
  static CaptureRequestKey get controlAELock =>
      PigeonOverrides.captureRequest_controlAELock ?? _controlAELock;
  ...
  ///
  /// This key is available on all devices.
  static CaptureRequestKey get controlVideoStabilizationMode =>
      PigeonOverrides.captureRequest_controlVideoStabilizationMode ??
      _controlVideoStabilizationMode;
...
class CaptureRequestOptions extends PigeonInternalProxyApiBaseClass {
  factory CaptureRequestOptions({
    ...
    if (PigeonOverrides.captureRequestOptions_new != null) {
      return PigeonOverrides.captureRequestOptions_new!(options: options);
    }
    return CaptureRequestOptions.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      options: options,
    );
  ...
  @protected
  CaptureRequestOptions.pigeon_new({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required Map<CaptureRequestKey, Object?> options,
  }) {
...
class Camera2CameraControl extends PigeonInternalProxyApiBaseClass {
  ...
  factory Camera2CameraControl.from({
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
  ...
  /// Gets the `Camera2CameraControl` from a `CameraControl`.
  @protected
  Camera2CameraControl.pigeon_from({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required CameraControl cameraControl,
  }) {
...
class ResolutionFilter extends PigeonInternalProxyApiBaseClass {
  factory ResolutionFilter.createWithOnePreferredSize({
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    required CameraSize preferredSize,
  }) {
    if (PigeonOverrides.resolutionFilter_createWithOnePreferredSize != null) {
      return PigeonOverrides.resolutionFilter_createWithOnePreferredSize!(
        preferredSize: preferredSize,
      );
    }
    return ResolutionFilter.pigeon_createWithOnePreferredSize(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      preferredSize: preferredSize,
    );
  ...
  @protected
  ResolutionFilter.pigeon_createWithOnePreferredSize({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required CameraSize preferredSize,
  }) {
...
class CameraCharacteristics extends PigeonInternalProxyApiBaseClass {
  ...
  ///
  /// This key is available on all devices.
  static final CameraCharacteristicsKey _infoSupportedHardwareLevel =
  ...
  ///
  /// This key is available on all devices.
  static CameraCharacteristicsKey get infoSupportedHardwareLevel =>
      PigeonOverrides.cameraCharacteristics_infoSupportedHardwareLevel ??
      _infoSupportedHardwareLevel;
...
class Camera2CameraInfo extends PigeonInternalProxyApiBaseClass {
  ...
  factory Camera2CameraInfo.from({
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    required CameraInfo cameraInfo,
  }) {
    if (PigeonOverrides.camera2CameraInfo_from != null) {
      return PigeonOverrides.camera2CameraInfo_from!(cameraInfo: cameraInfo);
    }
    return Camera2CameraInfo.pigeon_from(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      cameraInfo: cameraInfo,
    );
  ...
  Future<double?> getEquivalentFocalLength() async {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec = _pigeonVar_codecCamera2CameraInfo;
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const pigeonVar_channelName =
...
class DisplayOrientedMeteringPointFactory extends MeteringPointFactory {
  ...
  /// CameraInfo.
  factory DisplayOrientedMeteringPointFactory({
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    required CameraInfo cameraInfo,
    required double width,
    ...
    if (PigeonOverrides.displayOrientedMeteringPointFactory_new != null) {
      return PigeonOverrides.displayOrientedMeteringPointFactory_new!(
        cameraInfo: cameraInfo,
        width: width,
        height: height,
      );
    }
    return DisplayOrientedMeteringPointFactory.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      cameraInfo: cameraInfo,
      width: width,
  ...
  /// CameraInfo.
  @protected
  DisplayOrientedMeteringPointFactory.pigeon_new({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required CameraInfo cameraInfo,
    required double width,
...
class PlatformEffectsValues extends PigeonInternalProxyApiBaseClass {
  factory PlatformEffectsValues({
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    required double vignetteIntensity,
    String? grainNoisePath,
    ...
    if (PigeonOverrides.platformEffectsValues_new != null) {
      return PigeonOverrides.platformEffectsValues_new!(
    ...
    return PlatformEffectsValues.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      vignetteIntensity: vignetteIntensity,
      grainNoisePath: grainNoisePath,
  ...
  @protected
  PlatformEffectsValues.pigeon_new({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    ...
    final int pigeonVar_instanceIdentifier = pigeon_instanceManager.addDartCreatedInstance(this);
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _pigeonVar_codecPlatformEffectsValues;
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const pigeonVar_channelName =
  ...
  /// Constructs [PlatformEffectsValues] without creating the associated native object.
  ///
  /// This should only be used by subclasses created by this library or to
  /// create copies for an [PigeonInstanceManager].
  @protected
  PlatformEffectsValues.pigeon_detached({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required this.vignetteIntensity,
    this.grainNoisePath,
  ...
  late final _PigeonInternalProxyApiBaseCodec _pigeonVar_codecPlatformEffectsValues =
      _PigeonInternalProxyApiBaseCodec(pigeon_instanceManager);
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    PlatformEffectsValues Function(
    ...
    final BinaryMessenger? binaryMessenger = pigeon_binaryMessenger;
    {
      ...
      if (pigeon_clearHandlers) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(
            message != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.PlatformEffectsValues.pigeon_newInstance was null.',
          );
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_pigeon_instanceIdentifier = (args[0] as int?);
          assert(
            arg_pigeon_instanceIdentifier != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.PlatformEffectsValues.pigeon_newInstance was null, expected non-null int.',
          );
          final double? arg_vignetteIntensity = (args[1] as double?);
          assert(
            arg_vignetteIntensity != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.PlatformEffectsValues.pigeon_newInstance was null, expected non-null double.',
          );
          final String? arg_grainNoisePath = (args[2] as String?);
          final double? arg_grainOpacity = (args[3] as double?);
          assert(
            arg_grainOpacity != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.PlatformEffectsValues.pigeon_newInstance was null, expected non-null double.',
          );
          final double? arg_grainSize = (args[4] as double?);
          assert(
            arg_grainSize != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.PlatformEffectsValues.pigeon_newInstance was null, expected non-null double.',
          );
          ...
          assert(
            arg_grainBehavior != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.PlatformEffectsValues.pigeon_newInstance was null, expected non-null PlatformGrainBehavior.',
          );
          final String? arg_lutFilePath = (args[6] as String?);
          final double? arg_lutIntensity = (args[7] as double?);
          assert(
            arg_lutIntensity != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.PlatformEffectsValues.pigeon_newInstance was null, expected non-null double.',
          );
          ...
          assert(
            arg_cheapFisheye != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.PlatformEffectsValues.pigeon_newInstance was null, expected non-null bool.',
          );
            ...
            (pigeon_instanceManager ?? PigeonInstanceManager.instance).addHostCreatedInstance(
              pigeon_newInstance?.call(
                  ...
                  PlatformEffectsValues.pigeon_detached(
                    pigeon_binaryMessenger: pigeon_binaryMessenger,
                    pigeon_instanceManager: pigeon_instanceManager,
                    vignetteIntensity: arg_vignetteIntensity!,
                    grainNoisePath: arg_grainNoisePath,
                    grainOpacity: arg_grainOpacity!,
                    grainSize: arg_grainSize!,
  ...
  @override
  PlatformEffectsValues pigeon_copy() {
    return PlatformEffectsValues.pigeon_detached(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      vignetteIntensity: vignetteIntensity,
      grainNoisePath: grainNoisePath,
...
class CapturedPicturePaths extends PigeonInternalProxyApiBaseClass {
  /// Constructs [CapturedPicturePaths] without creating the associated native object.
  ///
  /// This should only be used by subclasses created by this library or to
  /// create copies for an [PigeonInstanceManager].
  @protected
  CapturedPicturePaths.pigeon_detached({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    this.originalPath,
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    CapturedPicturePaths Function(String? originalPath, String processedPath)? pigeon_newInstance,
  }) {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec = _PigeonInternalProxyApiBaseCodec(
      pigeon_instanceManager ?? PigeonInstanceManager.instance,
    );
    final BinaryMessenger? binaryMessenger = pigeon_binaryMessenger;
    {
      ...
      if (pigeon_clearHandlers) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(
            message != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.CapturedPicturePaths.pigeon_newInstance was null.',
          );
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_pigeon_instanceIdentifier = (args[0] as int?);
          assert(
            arg_pigeon_instanceIdentifier != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.CapturedPicturePaths.pigeon_newInstance was null, expected non-null int.',
          );
          final String? arg_originalPath = (args[1] as String?);
          final String? arg_processedPath = (args[2] as String?);
          assert(
            arg_processedPath != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.CapturedPicturePaths.pigeon_newInstance was null, expected non-null String.',
          );
          try {
            (pigeon_instanceManager ?? PigeonInstanceManager.instance).addHostCreatedInstance(
              pigeon_newInstance?.call(arg_originalPath, arg_processedPath!) ??
                  CapturedPicturePaths.pigeon_detached(
                    pigeon_binaryMessenger: pigeon_binaryMessenger,
                    pigeon_instanceManager: pigeon_instanceManager,
                    originalPath: arg_originalPath,
                    processedPath: arg_processedPath!,
                  ),
              arg_pigeon_instanceIdentifier!,
            );
            return wrapResponse(empty: true);
  ...
  @override
  CapturedPicturePaths pigeon_copy() {
    return CapturedPicturePaths.pigeon_detached(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
...
class CameraEffect extends PigeonInternalProxyApiBaseClass {
  /// Constructs [CameraEffect] without creating the associated native object.
  ///
  /// This should only be used by subclasses created by this library or to
  /// create copies for an [PigeonInstanceManager].
  @protected
  CameraEffect.pigeon_detached({super.pigeon_binaryMessenger, super.pigeon_instanceManager});

  static void pigeon_setUpMessageHandlers({
    bool pigeon_clearHandlers = false,
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    CameraEffect Function()? pigeon_newInstance,
  }) {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec = _PigeonInternalProxyApiBaseCodec(
      pigeon_instanceManager ?? PigeonInstanceManager.instance,
    );
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.camera_android_camerax.CameraEffect.pigeon_newInstance',
        pigeonChannelCodec,
        binaryMessenger: binaryMessenger,
      );
      if (pigeon_clearHandlers) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(
            message != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.CameraEffect.pigeon_newInstance was null.',
          );
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_pigeon_instanceIdentifier = (args[0] as int?);
          assert(
            arg_pigeon_instanceIdentifier != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.CameraEffect.pigeon_newInstance was null, expected non-null int.',
          );
          try {
            (pigeon_instanceManager ?? PigeonInstanceManager.instance).addHostCreatedInstance(
              pigeon_newInstance?.call() ??
                  CameraEffect.pigeon_detached(
                    pigeon_binaryMessenger: pigeon_binaryMessenger,
                    pigeon_instanceManager: pigeon_instanceManager,
                  ),
              arg_pigeon_instanceIdentifier!,
  ...
  @override
  CameraEffect pigeon_copy() {
    return CameraEffect.pigeon_detached(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
    );
  }
...
class ViewPort extends PigeonInternalProxyApiBaseClass {
  factory ViewPort({
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    required int aspectRatioWidth,
    ...
    if (PigeonOverrides.viewPort_new != null) {
      return PigeonOverrides.viewPort_new!(
        aspectRatioWidth: aspectRatioWidth,
        aspectRatioHeight: aspectRatioHeight,
        rotation: rotation,
      );
    }
    return ViewPort.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      aspectRatioWidth: aspectRatioWidth,
      aspectRatioHeight: aspectRatioHeight,
  ...
  ViewPort.pigeon_new({
    ...
    final int pigeonVar_instanceIdentifier = pigeon_instanceManager.addDartCreatedInstance(this);
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec = _pigeonVar_codecViewPort;
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const pigeonVar_channelName =
  ...
  /// Constructs [ViewPort] without creating the associated native object.
  ///
  /// This should only be used by subclasses created by this library or to
  /// create copies for an [PigeonInstanceManager].
  @protected
  ViewPort.pigeon_detached({super.pigeon_binaryMessenger, super.pigeon_instanceManager});

  late final _PigeonInternalProxyApiBaseCodec _pigeonVar_codecViewPort =
      _PigeonInternalProxyApiBaseCodec(pigeon_instanceManager);
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    ViewPort Function()? pigeon_newInstance,
  }) {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec = _PigeonInternalProxyApiBaseCodec(
      pigeon_instanceManager ?? PigeonInstanceManager.instance,
    );
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.camera_android_camerax.ViewPort.pigeon_newInstance',
        pigeonChannelCodec,
        binaryMessenger: binaryMessenger,
      );
      if (pigeon_clearHandlers) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(
            message != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.ViewPort.pigeon_newInstance was null.',
          );
          final List<Object?> args = (message as List<Object?>?)!;
          final int? arg_pigeon_instanceIdentifier = (args[0] as int?);
          assert(
            arg_pigeon_instanceIdentifier != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.ViewPort.pigeon_newInstance was null, expected non-null int.',
          );
          try {
            (pigeon_instanceManager ?? PigeonInstanceManager.instance).addHostCreatedInstance(
              pigeon_newInstance?.call() ??
...
class CameraEffectsManager extends PigeonInternalProxyApiBaseClass {
  ...
  factory CameraEffectsManager({
    ...
    if (PigeonOverrides.cameraEffectsManager_new != null) {
      return PigeonOverrides.cameraEffectsManager_new!(
        onPreviewSizeChanged: onPreviewSizeChanged,
        onPreviewOutputLost: onPreviewOutputLost,
        aspectRatio: aspectRatio,
      );
    }
    return CameraEffectsManager.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      onPreviewSizeChanged: onPreviewSizeChanged,
      onPreviewOutputLost: onPreviewOutputLost,
  ...
  /// (width/height); null means no crop.
  @protected
  CameraEffectsManager.pigeon_new({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required this.onPreviewSizeChanged,
    required this.onPreviewOutputLost,
    double? aspectRatio,
  }) {
    final int pigeonVar_instanceIdentifier = pigeon_instanceManager.addDartCreatedInstance(this);
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
  ...
  /// Constructs [CameraEffectsManager] without creating the associated native object.
  ///
  /// This should only be used by subclasses created by this library or to
  /// create copies for an [PigeonInstanceManager].
  @protected
  CameraEffectsManager.pigeon_detached({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required this.onPreviewSizeChanged,
    required this.onPreviewOutputLost,
  ...
  late final _PigeonInternalProxyApiBaseCodec _pigeonVar_codecCameraEffectsManager =
      _PigeonInternalProxyApiBaseCodec(pigeon_instanceManager);
  ...
  /// ```dart
  /// final WeakReference weakMyVariable = WeakReference(myVariable);
  /// final CameraEffectsManager instance = CameraEffectsManager(
  ///  onPreviewSizeChanged: (CameraEffectsManager pigeon_instance, ...) {
  ///    print(weakMyVariable?.target);
  ///  },
  /// );
  /// ```
  ...
  /// Alternatively, [PigeonInstanceManager.removeWeakReference] can be used to
  /// release the associated Native object manually.
  final void Function(CameraEffectsManager pigeon_instance, int width, int height)
  onPreviewSizeChanged;
  ...
  /// final WeakReference weakMyVariable = WeakReference(myVariable);
  /// final CameraEffectsManager instance = CameraEffectsManager(
  ///  onPreviewOutputLost: (CameraEffectsManager pigeon_instance, ...) {
  ///    print(weakMyVariable?.target);
  ///  },
  /// );
  /// ```
  ...
  /// Alternatively, [PigeonInstanceManager.removeWeakReference] can be used to
  /// release the associated Native object manually.
  final void Function(CameraEffectsManager pigeon_instance) onPreviewOutputLost;

  static void pigeon_setUpMessageHandlers({
    bool pigeon_clearHandlers = false,
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    void Function(CameraEffectsManager pigeon_instance, int width, int height)?
    onPreviewSizeChanged,
    void Function(CameraEffectsManager pigeon_instance)? onPreviewOutputLost,
  }) {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec = _PigeonInternalProxyApiBaseCodec(
      pigeon_instanceManager ?? PigeonInstanceManager.instance,
    );
    final BinaryMessenger? binaryMessenger = pigeon_binaryMessenger;
    {
      ...
      if (pigeon_clearHandlers) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(
            message != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.CameraEffectsManager.onPreviewSizeChanged was null.',
          );
          final List<Object?> args = (message as List<Object?>?)!;
          final CameraEffectsManager? arg_pigeon_instance = (args[0] as CameraEffectsManager?);
          assert(
            arg_pigeon_instance != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.CameraEffectsManager.onPreviewSizeChanged was null, expected non-null CameraEffectsManager.',
          );
          final int? arg_width = (args[1] as int?);
          assert(
            arg_width != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.CameraEffectsManager.onPreviewSizeChanged was null, expected non-null int.',
          );
          final int? arg_height = (args[2] as int?);
          assert(
            arg_height != null,
          ...
          try {
            (onPreviewSizeChanged ?? arg_pigeon_instance!.onPreviewSizeChanged).call(
              arg_pigeon_instance!,
              arg_width!,
              arg_height!,
            );
...

    {
      ...
      if (pigeon_clearHandlers) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(
            message != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.CameraEffectsManager.onPreviewOutputLost was null.',
          );
          final List<Object?> args = (message as List<Object?>?)!;
          final CameraEffectsManager? arg_pigeon_instance = (args[0] as CameraEffectsManager?);
          assert(
            arg_pigeon_instance != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.CameraEffectsManager.onPreviewOutputLost was null, expected non-null CameraEffectsManager.',
          );
          try {
            (onPreviewOutputLost ?? arg_pigeon_instance!.onPreviewOutputLost).call(
              arg_pigeon_instance!,
            );
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
  ...
  Future<void> notifyPreviewSize() async {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _pigeonVar_codecCameraEffectsManager;
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const pigeonVar_channelName =
  ...
  Future<CameraEffect> getCameraEffect() async {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _pigeonVar_codecCameraEffectsManager;
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const pigeonVar_channelName =
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as CameraEffect?)!;
    }
  }
  ...
  Future<void> setEffectsValues(PlatformEffectsValues values) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[this, values]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
  ...
  Future<void> setCaptureScale(double scale) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[this, scale]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
  ...
  Future<void> setCaptureCornerRadius(double radius) async {
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[this, radius]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
  ...
  Future<void> detachOutputs() async {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec =
        _pigeonVar_codecCameraEffectsManager;
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const pigeonVar_channelName =
  ...
  @override
  CameraEffectsManager pigeon_copy() {
    return CameraEffectsManager.pigeon_detached(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      onPreviewSizeChanged: onPreviewSizeChanged,
      onPreviewOutputLost: onPreviewOutputLost,
...
class WhiteBalanceManager extends PigeonInternalProxyApiBaseClass {
  factory WhiteBalanceManager({
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    required void Function(WhiteBalanceManager pigeon_instance, double temperature, double tint)
    onAutoWhiteBalanceChanged,
  }) {
    if (PigeonOverrides.whiteBalanceManager_new != null) {
      return PigeonOverrides.whiteBalanceManager_new!(
        onAutoWhiteBalanceChanged: onAutoWhiteBalanceChanged,
      );
    }
    return WhiteBalanceManager.pigeon_new(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      onAutoWhiteBalanceChanged: onAutoWhiteBalanceChanged,
    );
  ...
  @protected
  WhiteBalanceManager.pigeon_new({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required this.onAutoWhiteBalanceChanged,
  }) {
    final int pigeonVar_instanceIdentifier = pigeon_instanceManager.addDartCreatedInstance(this);
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec = _pigeonVar_codecWhiteBalanceManager;
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const pigeonVar_channelName =
  ...
  /// Constructs [WhiteBalanceManager] without creating the associated native object.
  ///
  /// This should only be used by subclasses created by this library or to
  /// create copies for an [PigeonInstanceManager].
  @protected
  WhiteBalanceManager.pigeon_detached({
    super.pigeon_binaryMessenger,
    super.pigeon_instanceManager,
    required this.onAutoWhiteBalanceChanged,
  });

  late final _PigeonInternalProxyApiBaseCodec _pigeonVar_codecWhiteBalanceManager =
      _PigeonInternalProxyApiBaseCodec(pigeon_instanceManager);
  ...
  /// ```dart
  /// final WeakReference weakMyVariable = WeakReference(myVariable);
  /// final WhiteBalanceManager instance = WhiteBalanceManager(
  ///  onAutoWhiteBalanceChanged: (WhiteBalanceManager pigeon_instance, ...) {
  ///    print(weakMyVariable?.target);
  ///  },
  /// );
  /// ```
  ...
  /// Alternatively, [PigeonInstanceManager.removeWeakReference] can be used to
  /// release the associated Native object manually.
  final void Function(WhiteBalanceManager pigeon_instance, double temperature, double tint)
  onAutoWhiteBalanceChanged;
  ...
  static void pigeon_setUpMessageHandlers({
    ...
    BinaryMessenger? pigeon_binaryMessenger,
    PigeonInstanceManager? pigeon_instanceManager,
    void Function(WhiteBalanceManager pigeon_instance, double temperature, double tint)?
    onAutoWhiteBalanceChanged,
  }) {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec = _PigeonInternalProxyApiBaseCodec(
      pigeon_instanceManager ?? PigeonInstanceManager.instance,
    ...
    final BinaryMessenger? binaryMessenger = pigeon_binaryMessenger;
    {
      ...
      if (pigeon_clearHandlers) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          assert(
            message != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.WhiteBalanceManager.onAutoWhiteBalanceChanged was null.',
          );
          final List<Object?> args = (message as List<Object?>?)!;
          final WhiteBalanceManager? arg_pigeon_instance = (args[0] as WhiteBalanceManager?);
          assert(
            arg_pigeon_instance != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.WhiteBalanceManager.onAutoWhiteBalanceChanged was null, expected non-null WhiteBalanceManager.',
          );
          final double? arg_temperature = (args[1] as double?);
          assert(
            arg_temperature != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.WhiteBalanceManager.onAutoWhiteBalanceChanged was null, expected non-null double.',
          );
          final double? arg_tint = (args[2] as double?);
          assert(
            arg_tint != null,
            'Argument for dev.flutter.pigeon.camera_android_camerax.WhiteBalanceManager.onAutoWhiteBalanceChanged was null, expected non-null double.',
          );
          try {
            (onAutoWhiteBalanceChanged ?? arg_pigeon_instance!.onAutoWhiteBalanceChanged).call(
              arg_pigeon_instance!,
              arg_temperature!,
              arg_tint!,
            );
  ...
  Future<bool> isWhiteBalanceSupported(Camera2CameraInfo cameraInfo) async {
    final _PigeonInternalProxyApiBaseCodec pigeonChannelCodec = _pigeonVar_codecWhiteBalanceManager;
    final BinaryMessenger? pigeonVar_binaryMessenger = pigeon_binaryMessenger;
    const pigeonVar_channelName =
  ...
  @override
  WhiteBalanceManager pigeon_copy() {
    return WhiteBalanceManager.pigeon_detached(
      pigeon_binaryMessenger: pigeon_binaryMessenger,
      pigeon_instanceManager: pigeon_instanceManager,
      onAutoWhiteBalanceChanged: onAutoWhiteBalanceChanged,
    );
