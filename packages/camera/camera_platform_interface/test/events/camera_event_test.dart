...
void main() {
  ...
  group('CameraAutoWhiteBalanceChangedEvent tests', () {
    ...
    test('equals returns false when any field differs', () {
      ...
      expect(base == const CameraAutoWhiteBalanceChangedEvent(2, 5500, 12), false);
      expect(base == const CameraAutoWhiteBalanceChangedEvent(1, 5400, 12), false);
      expect(base == const CameraAutoWhiteBalanceChangedEvent(1, 5500, 13), false);
    });

    test('fromJson should initialize all properties', () {
      final event = CameraAutoWhiteBalanceChangedEvent.fromJson(const <String, dynamic>{
        'cameraId': 1,
        'temperature': 5500.0,
        'tint': 12.0,
      });
    ...
    test('toJson roundtrips through fromJson', () {
      ...
      final roundTripped = CameraAutoWhiteBalanceChangedEvent.fromJson(event.toJson());
