...
class WhiteBalanceValues {
  ...
  WhiteBalanceValues({required this.temperature, required this.tint}) {
  ...
  bool operator ==(Object other) =>
      ...
      other is WhiteBalanceValues && other.temperature == temperature && other.tint == tint;
  ...
  @override
  String toString() =>
      'WhiteBalanceValues(temperature: $temperature, '
      'tint: $tint)';
}
